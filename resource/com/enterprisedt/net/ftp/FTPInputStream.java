 ...
 *    Revision 1.6  2013/09/11 00:36:46  bruceb
 *    set monitor correctly for internal streams
 *
...
public class FTPInputStream extends FileTransferInputStream {
    ...
    public FTPInputStream(FTPClient client, String remoteFile, long offset) throws IOException, FTPException {
        ...
        if (!client.existsFile(remoteFile))
        ...
        // have to set the monitor to ensure transferComplete is called
        stream.setMonitor(monitorEx, monitorInterval);
    }
    ...
    public void setMonitor(FTPProgressMonitorEx monitor, long monitorInterval) {
        ...
        stream.setMonitor(monitor, monitorInterval);
    }
