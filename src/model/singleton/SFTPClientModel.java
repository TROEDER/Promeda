...
public final class SFTPClientModel {
	 ...
	 * @param ftpPwd
	 ******************************************************************************/
	public SFTPClientModel(String ftpHost, int ftpPort, String ftpUser, String ftpPwd) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SFTPClientModel.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		}
//		connect();
	}
